 ...
 * @version		1.0.0
 */
$page = 'chilean-crusted-salmon';
$subpage = '';
include 'header.php'; ?>
<div class="single-landing salmon">
    <div class="banner banner-news nofilter" style="background-image: url(img/landing/salmon_full.jpg)"></div>
    ...
    <div class="banner banner-news--content">
        <div class="receta--descripcion">
            <div class="receta--descripcion--left">
                <h3 class="receta__title">Chilean Crusted Salmon</h3>
            </div>
            <a href="download/VM_White%20Tearpad.pdf" target="_blank" download class="btn btn__border bigger" title="Download recipe">Download recipe</a>
        </div>
    </div>
    <div class="full--box box__color">
        <div class="box__color--content">
            ...
            <div class="box__color--left">
                <ul>
                    <li>4 SALMON FILLETS (6oz. each, skin on)<li>
                    <li>4 Tbsp OLIVE OIL</li>
                    <li>1 AVOCADO (large)</li>
                    <li>2 tsp CUMIN</li>
    ...
    <div class="full--box box__color preparacion">
        <div class="preparacion__content">
            <ol>
                ...
                <li>
                    In a bowl, combine the chili powder, paprika, garlic,olive oil (3 Tbsp) and the juice of 2 limes. Spread on the salmon. Let rest for 15 minutes.
                </li>
                <li>
                    In another bowl, stir the avocado, cumin, the juice of 2 limes, sour cream and sugar until smooth. Add salt and pepper to taste.
                </li>
                <li>
                    Heat a large nonstick pan over medium-high heat and wait until hot (2-3 minutes). Brush surface with remaining olive oil and add the salmon skin-side down. Reduce the heat to medium-low and cook until skin is crispy (about 6 minutes).
                </li>
                <li>
                    Turn the salmon over and cook the flesh side until medium/medium rare (2-3 minutes).

                </li>
                <li>
                    Remove the salmon from the skin and move to a warmed serving dish. Cover loosely with foil and rest for 5 minutes. Spoon sauce on top of fish and serve.
                </li>
                <li>
                    <strong>4 SERVINGS</strong>
                    Prep time: 20 minutes<br/>
                    Cook time: 10 minutes<br/>
                    <strong>Total time: 30 minutes</strong>
                </li>
            </ol>
