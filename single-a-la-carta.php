...
$subpage = '';
include 'header.php'; ?>
<div class="banner banner-news nofilter" style="background-image: url(assets/nuestra-viña.jpg)"></div>
<div class="banner banner-news--content">
    <div class="receta--descripcion">
        <div class="receta--descripcion--left">
            <h3 class="receta__title">Filetes de Vacuno en Salsa a la Pimienta con Papas Doradas con Tocino y Ciboulette y Verduras salteadas</h3>
        </div>
        <div class="receta--descripcion--right">
            <div class="receta-icon">
                <svg><use xlink:href="#shape-personas" /></svg>
                <span>4 personas</span>
            </div>
            <div class="receta-icon">
                <svg><use xlink:href="#shape-minutos" /></svg>
...
<div class="full--box box__color">
    <div class="box__color--content">
        ...
        <div class="box__color--left">
            <ul>
                <li>720g de filete de vacuno</li>
                <li>1 zapallo italiano cortado en tiras</li>
                <li>1 puerro cortado en tiras</li>
                <li>1 pimentón rojo cortado en tiras</li>
                <li>1 pimentón amarillo cortado en tiras</li>
                <li>2 tomates sin semillas y cortado en octavos</li>
                <li>600g papas semilla (pequeñas)</li>
                <li>100g tocino</li>
                <li>1 paquete de ciboulette</li>
                <li>150cc aceite de oliva</li>
                <li>Sal</li>
                <li>Pimienta molida</li>
            </ul>
        </div><!--/.box__color-left-->
        <div class="box__color--right">
            <h3 class="box__title">Para la salsa</h3>
            <ul>
                <li>1k de huesos de vacuno</li>
                <li>1 zanahoria cortada en cubos</li>
                <li>1 cebolla cortada en cubos</li>
                <li>1 puerro cortado en cubos</li>
                <li>50g de apio cortado en cubos</li>
                <li>40g de concentrado de tomates</li>
                <li>3l de agua fría</li>
                <li>3l de agua fría</li>
                <li>350cc de vino tinto</li>
                <li>10g de pimienta negra y verde en grano</li>
                <li>1 ramita de tomillo y romero </li>
            </ul>
...
<div class="full--box box__color preparacion">
    <div class="preparacion__content">
        <ul>
            <li>
                Comenzamos por la salsa, lavar los huesos. Ponerlos en una budinera y asar en horno a 210°C unos 30-45 minutos hasta un dorado intenso.
            </li>
            <li>
                En una olla aparte, dorar las verduras cortadas en cubos hasta un dorado intenso, agregar el concentrado de tomates y dorar un poco más.
            </li>
            <li>
                Agregar los huesos dorados, tomillo, romero, y el agua fría en la olla.
            </li>
            <li>
                Cocinar a fuego bajo durante 2 horas, retirar la grasa y la espuma. Al finalizar la cocción, pasar por un colador, desgrasar nuevamente si es necesario y reservar el caldo.
            </li>
            <li>
                Aparte en una cacerola poner el vino tinto y reducir a fuego bajo hasta que quede solo un tercio del vino, agregar 700 cc del caldo oscuro de vacuno y los pimentones para dejar que reduzca 5 minutos. Condimentar y reservar.
            </li>
            <li>
                Lavar y escobillar las papas, cocinar a partir de agua fría hasta que las papas estén blandas. Filtrarlas, cortarlas, ponerlas sobre una budinera, rociarlas con aceite, espolvorearlas con el tocino y ciboulette. Dorar en horno a 230°C por 5 minutos aproximadamente y luego reservar.
            </li>
            <li>
                Calentar un wok agregar un poco de aceite y agregar verduras cortadas en tiras, saltear, agregar tomates, salpimentar y reservar.
            </li>
            <li>
                Cortar el filete en medallones de 150 a 180 gr salpimentar, sellar en un grilla, marcar bien y terminar cocción al horno a 200° c por 5 minutos aproximadamente, servir inmediatamente acompañado con las papas doradas, las verduras y la salsa de pimienta.
            </li>
        </ul>
...
<div class="single-news">
    <div class="single-news--redes redes-receta">
        <div class="content-redes">
            ...
            <a href="#" class="btn btn__border bigger" title="Descargar esta receta">Descargar esta receta</a>
        </div>
    </div>
</div>
<div class="full-box more-wines more-wines--carta">
    <h4 class="full-box title">Sugerencias del chef</h4>
    <ul class="wine--list wine--list__small">
